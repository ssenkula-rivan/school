    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['is_active', 'is_public'], name='subscriptio_is_acti_281db9_idx')],
            },
        ),
        migrations.CreateModel(
            name='Subscription',
        ...
        migrations.AddIndex(
            model_name='subscription',
            index=models.Index(fields=['trial_end'], name='subscriptio_trial_e_f55464_idx'),
        ),
        migrations.AddIndex(
            model_name='subscription',
            index=models.Index(fields=['external_payment_id'], name='subscriptio_externa_0e8071_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='subscriptioninvoice',
            index=models.Index(fields=['-issue_date'], name='subscriptio_issue_d_7c160a_idx'),
        ),
    ]
